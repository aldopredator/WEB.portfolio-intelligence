  ...
  try {
    ...
    const allMetrics: ScoringMetrics[] = stocksWithCalculatedMetrics.map(stock => {
      ...
      return {
        ...
        evToEbitda: latestMetrics?.enterpriseValueEBITDA || undefined,
        roe: latestMetrics?.returnOnEquity || undefined,
        roa: latestMetrics?.returnOnAssets || undefined,
        profitMargin: latestMetrics?.profitMargin || undefined,
        revenueGrowth: latestMetrics?.quarterlyRevenueGrowth || undefined,
        earningsGrowth: latestMetrics?.quarterlyEarningsGrowth || undefined,
