    ...
    <div className="space-y-6">
      ...
      <div className="space-y-4">
        {Object.entries(GEOGRAPHIC_REGIONS).map(([regionName, regionCountries]) => {
          // Only show countries with stocks
          const countriesInRegion = countries.filter(
            ([country, stocks]) => regionCountries.includes(country) && stocks.length > 0
          );
          ...
          return (
            <div key={regionName}>
              <h2 className="text-lg font-semibold text-slate-300 mb-3 px-2">{regionName}</h2>
