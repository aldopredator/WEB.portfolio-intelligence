              ...
              <Typography variant="h6" sx={{ fontWeight: 700, color: (floatShares && sharesOutstanding) ? 'text.primary' : 'text.disabled' }}>
                {floatShares && sharesOutstanding
                  ? `${floatShares >= 1e9
                      ...
                      : floatShares.toLocaleString()} (${((floatShares / sharesOutstanding) * 100).toFixed(0)}%)`
                  : 'Loading...'}
              </Typography>
            </Box>
            <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
              <Typography variant="body2" sx={{ color: 'text.secondary' }}>
                Avg Daily Volume 10D (in %)
              </Typography>
              <Typography variant="h6" sx={{ fontWeight: 700, color: (averageVolume10Day && floatShares) ? 'text.primary' : 'text.disabled' }}>
                {averageVolume10Day && floatShares
                  ? `${averageVolume10Day >= 1e9
                      ...
                      : averageVolume10Day.toLocaleString()} (${((averageVolume10Day * 250 / floatShares) * 100).toFixed(2)}%)`
                  : 'N/A'}
              </Typography>
            </Box>
            <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
              <Typography variant="body2" sx={{ color: 'text.secondary' }}>
                Avg Daily Volume 3M (in %)
              </Typography>
              <Typography variant="h6" sx={{ fontWeight: 700, color: (averageVolume3Month && floatShares) ? 'text.primary' : 'text.disabled' }}>
                {averageVolume3Month && floatShares
                  ? `${averageVolume3Month >= 1e9
                      ...
                      : averageVolume3Month.toLocaleString()} (${((averageVolume3Month * 250 / floatShares) * 100).toFixed(2)}%)`
                  : 'N/A'}
              </Typography>
            </Box>
            <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
              <Typography variant="body2" sx={{ color: 'text.secondary' }}>
                % Held by Insiders vs. Institutions
              </Typography>
              <Typography variant="h6" sx={{ fontWeight: 700, color: (heldPercentInsiders || heldPercentInstitutions) ? 'text.primary' : 'text.disabled' }}>
                {(heldPercentInsiders || heldPercentInstitutions)
                  ? `${heldPercentInsiders?.toFixed(0) || '0'}% vs. ${heldPercentInstitutions?.toFixed(0) || '0'}%`
                  : 'Loading...'
              </Typography>
            </Box>
          </Stack>
